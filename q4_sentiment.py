...
REGULARIZATION = [0.000001,0.000003,0.000005,0.00001,0.00003,0.00005,0.0001,0.0003,0.0005,0.001,0.003,0.005,0.1,0.3]
### END YOUR CODE
...
for regularization in REGULARIZATION:
    ...
    weights = sgd(lambda weights: softmax_wrapper(trainFeatures, trainLabels,
                                                  weights, regularization), weights, 0.5, 10000, PRINT_EVERY=100)
